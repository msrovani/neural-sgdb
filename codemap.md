...
|-----------|------------------------|--------------|
| `src/` | Memory DB core: MemoryDoc NMD1, ART, BQ + Hamming SIMD, engine, Sgdb facade, Storage trait, TKLV codec, CRDT p2p | [View Map](src/codemap.md) |
| `examples/` | Showcase: bench (P50/P99 latency, recall vs FP32) + MCP server (remember/recall/rag_context) | [View Map](examples/codemap.md) |
| `docs/` | API contract (`api.md`), release notes | — |
