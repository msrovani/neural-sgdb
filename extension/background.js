// ESTACIONADO — não é o produto NSGDB (agêntico = MCP, não scraper de abas).
// Auto-captura history/tabs comentada. Reabrir só com ADR.
//
...
// --- viés browser (hoarding) DESLIGADO ---
