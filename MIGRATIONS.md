...
| MDM1 | v3 | side-table meta codec | — (via MemoryRecord) | `src/memory_doc.rs` |
...
| `sys/meta/` | `MemoryMeta` (memory_id, source, confidence, importance, created_tick, parent_ids, clock_overflow) | v0.6 |
...
3. Update the golden tests **in the same commit** (`golden_nmd1_bytes`,
   ...
   version (v1/v2/v3 intermediate decodes — see the MDM1 v3 bugfix).
