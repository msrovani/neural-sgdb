...
> Status: **current (v1.1.23)** — these documents describe the **shipped**
> cognitive memory system. Crate version in `Cargo.toml` is **1.1.23**; typed
...
> Feature releases through **v1.1.23** are documented in `CHANGELOG.md` and
