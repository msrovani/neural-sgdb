...
> Status: **current (v1.1.26)** — these documents describe the **shipped**
> cognitive memory system. Crate version in `Cargo.toml` is **1.1.27**; typed
...
> Feature releases through **v1.1.26** are documented in `CHANGELOG.md` and
