...
> **Status:** alinhado a **v1.1.20** / ADR-0010 (implemented).  
...
| Origem (errado / desatualizado) | Contrato real (v1.1.19–1.1.20) |
|---------------------------------|--------------------------------|
...
# Memory: neural-sgdb MCP (remember / recall / health / curate) — v1.1.20+
...
# Context: Verify Harness Engineering support against shipped crate (v1.1.20+)
