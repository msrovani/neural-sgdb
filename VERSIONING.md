...
Crate version in `Cargo.toml` is **1.1.8**; additive feature releases
**v1.1.2–v1.1.8** are documented in `CHANGELOG.md` and `docs/api.md` without
...
(`ensure_doctrine`, MCP `initialize.instructions`) and a 4-tool MCP surface.